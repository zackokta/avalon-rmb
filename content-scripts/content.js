var content = function() {
    ...
    function Me(t, e, n) {
        ...
        const s = Oe(t, e, !0, 0);
        return s.observers = null, s.observerSlots = null, s.comparator = n.equals || void 0, re(s), ut.bind(s)
    }
        ...
        return (!t.comparator || !t.comparator(s, e)) && (t.value = e, t.observers && t.observers.length && V(() => {
            for (let r = 0; r < t.observers.length; r += 1) {
                const o = t.observers[r],
                    i = Ie && Ie.running;
                i && Ie.disposed.has(o), (i ? !o.tState : !o.state) && (o.pure ? T.push(o) : B.push(o), o.observers && gt(o)), i || (o.state = W)
            }
    ...
    function Zt(t, e, n) {
        ...
        try {
            ...
            return t.pure && (t.state = W, t.owned && t.owned.forEach(oe), t.owned = null), t.updatedAt = n + 1, ft(i)
        } finally {
            _ = o, C = r
        }(!t.updatedAt || t.updatedAt <= n) && (t.updatedAt != null && "observers" in t ? dt(t, s) : t.value = s, t.updatedAt = n)
    }
    ...
    function Oe(t, e, n, s = W, r) {
        ...
        return C === null || C !== at && (C.owned ? C.owned.push(o) : C.owned = [o]), o
    }

    function fe(t) {
        if (t.state === 0) return;
        if (t.state === me) return he(t);
        if (t.suspense && se(t.suspense.inFallback)) return t.suspense.effects.push(t);
        const e = [t];
        for (;
            (t = t.owner) && (!t.updatedAt || t.updatedAt < ge);) t.state && e.push(t);
    ...
    function he(t, e) {
        ...
        for (let n = 0; n < t.sources.length; n += 1) {
            ...
            if (s.sources) {
                const r = s.state;
                r === W ? s !== e && (!s.updatedAt || s.updatedAt < ge) && fe(s) : r === me && he(s, e)
            }
        }
    }
    ...
    function gt(t) {
        for (let e = 0; e < t.observers.length; e += 1) {
            ...
            n.state || (n.state = me, n.pure ? T.push(n) : B.push(n), n.observers && gt(n))
        }
    }
    ...
    function ke(t) {
        ...
        return Me(() => {
            ...
            if (r) {
                const o = t.children;
                return typeof o == "function" && o.length > 0 ? se(() => o(e ? r : () => {
    ...
    function Yt() {
        if (ht) return Le;
        ht = 1;
        var t = /^[a-z](?:[\.0-9_a-z\xB7\xC0-\xD6\xD8-\xF6\xF8-\u037D\u037F-\u1FFF\u200C\u200D\u203F\u2040\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]|[\uD800-\uDB7F][\uDC00-\uDFFF])*-(?:[\x2D\.0-9_a-z\xB7\xC0-\xD6\xD8-\xF6\xF8-\u037D\u037F-\u1FFF\u200C\u200D\u203F\u2040\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]|[\uD800-\uDB7F][\uDC00-\uDFFF])*$/,
            e = function(n) {
                return t.test(n)
            };
        return Le = e, Le
    ...
    var tn = (t, e, n) => new Promise((s, r) => {
        var o = l => {
            ...
            a = l => l.done ? s(l.value) : Promise.resolve(l.value).then(o, i);
    ...
    function nn(t) {
        return tn(this, null, function*() {
            ...
            if (!en(e)) throw Error(`"${e}" is not a valid custom element name. It must be two words and kebab-case, with a few exceptions. See spec for more details: https://html.spec.whatwg.org/multipage/custom-elements.html#valid-custom-element-name`);
            ...
            if (s) {
                ...
                "url" in s ? m.textContent = yield fetch(s.url).then(f => f.text()): m.textContent = s.textContent, c.appendChild(m)
            }
            return a.appendChild(c), a.appendChild(l), i.appendChild(a), r && (Array.isArray(r) ? r : ["keydown", "keyup", "keypress"]).forEach(f => {
    ...
    class on extends Map {
        constructor() {
            ...
            const [e] = arguments;
            if (e != null) {
                if (typeof e[Symbol.iterator] != "function") throw new TypeError(typeof e + " is not iterable (cannot read property Symbol(Symbol.iterator))");
                for (const [n, s] of e) this.set(n, s)
            }
        }
        _getPublicKeys(e, n = !1) {
            if (!Array.isArray(e)) throw new TypeError("The keys parameter must be an array");
            const s = this._getPrivateKey(e, n);
            let r;
            return s && this._publicKeys.has(s) ? r = this._publicKeys.get(s) : n && (r = [...e], this._publicKeys.set(s, r)), {
                privateKey: s,
                publicKey: r
            }
        }
        _getPrivateKey(e, n = !1) {
            ...
            for (let r of e) {
                r === null && (r = sn);
                const o = typeof r == "object" || typeof r == "function" ? "_objectHashes" : typeof r == "symbol" ? "_symbolHashes" : !1;
                if (!o) s.push(r);
        ...
        set(e, n) {
            const {
                publicKey: s
            } = this._getPublicKeys(e, !0);
            return super.set(s, n)
        }
        get(e) {
            const {
                publicKey: n
            } = this._getPublicKeys(e);
            return super.get(n)
        }
        has(e) {
            const {
    ...
    function Fe(t, e, n = ".", s) {
        ...
        for (const o in t) {
            ...
            const i = t[o];
            i != null && (s && s(r, o, i, n) || (Array.isArray(i) && Array.isArray(r[o]) ? r[o] = [...i, ...r[o]] : De(i) && De(r[o]) ? r[o] = Fe(i, r[o], (n ? `${n}.` : "") + o.toString(), s) : r[o] = i))
        }
        return r
    }
    ...
    function mn(t) {
        ...
        return (n, s) => {
            const {
                ...
                signal: l,
                customMatcher: c
            } = dn(s, e), m = [n, r, o, i, a, l, c], f = $e.get(m);
            if (o && f) return f;
    ...
    function fn(t, e, n) {
        n.position !== "inline" && (n.zIndex != null && (t.style.zIndex = String(n.zIndex)), t.style.overflow = "visible", t.style.position = "relative", t.style.width = "0", t.style.height = "0", t.style.display = "block", e && (n.position === "overlay" ? (e.style.position = "absolute", n.alignment?.startsWith("bottom-") ? e.style.bottom = "0" : e.style.top = "0", n.alignment?.endsWith("-right") ? e.style.right = "0" : e.style.left = "0") : (e.style.position = "fixed", e.style.top = "0", e.style.bottom = "0", e.style.left = "0", e.style.right = "0")))
    }

    function Be(t) {
        if (t.anchor == null) return document.body;
        let e = typeof t.anchor == "function" ? t.anchor() : t.anchor;
        return typeof e == "string" ? e.startsWith("/") ? document.evaluate(e, document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue ?? void 0 : document.querySelector(e) ?? void 0 : e ?? void 0
    }

    function hn(t, e) {
        const n = Be(e);
        if (n == null) throw Error("Failed to mount content script UI: could not find anchor element");
        switch (e.append) {
            case void 0:
            case "last":
                n.append(t);
    ...
    function pn(t, e) {
        ...
        return {
            ...
            autoMount: l => {
                n && je.warn("autoMount is already set."), n = yn({
                    mount: r,
                    unmount: o,
                    stopAutoMount: s
                }, {
    ...
    function yn(t, e) {
        ...
        if (o instanceof Element) throw Error("autoMount and Element anchor option cannot be combined. Avoid passing `Element` directly or `() => Element` to the anchor.");
        async function i(a) {
            let l = !!Be(e);
            for (l && t.mount(); !n.signal.aborted;) try {
                l = !!await gn(a ?? "body", {
    ...
    function wn(t) {
        ...
        let r;
        for (;
            (r = s.exec(t)) !== null;) n += r[1], e = e.replace(r[1], "");
        return {
            documentCss: n.trim(),
            shadowCss: e.trim()
        }
    ...
    async function An(t, e) {
        const n = Math.random().toString(36).substring(2, 15),
            s = [];
        if (e.inheritStyles || s.push("/* WXT Shadow Root Reset */ :host{all:initial !important;}"), e.css && s.push(e.css), t.options?.cssInjectionMode === "ui") {
            const d = await bn();
...
`).trim()), {
        ...
        let c;
        const m = () => {
                if (hn(a, e), fn(a, l.querySelector("html"), e), o && !document.querySelector(`style[wxt-shadow-root-document-styles="${n}"]`)) {
                    const d = document.createElement("style");
                    d.textContent = o, d.setAttribute("wxt-shadow-root-document-styles", n), (document.head ?? document.body).append(d)
                }
                c = e.onMount(i, l, a)
            },
            f = () => {
                for (e.onRemove?.(c), a.remove(), document.querySelector(`style[wxt-shadow-root-document-styles="${n}"]`)?.remove(); i.lastChild;) i.removeChild(i.lastChild);
                c = void 0
            },
            h = pn({
                mount: m,
    ...
    async function bn() {
        ...
        try {
            ...
            return je.warn(`Failed to load styles @ ${t}. Did you forget to import the stylesheet in your entrypoint?`, e), ""
        }
    }
    ...
    function En(t, e, n) {
        ...
        for (; i < r || a < o;) {
            ...
            if (r === i) {
                ...
                t.insertBefore(n[a++], e[i++].nextSibling), t.insertBefore(n[--o], m), e[r] = n[o]
            } else {
                if (!c) {
                    c = new Map;
                    let f = a;
                ...
                if (m != null)
                    if (a < m && m < o) {
                        let f = i,
                            h = 1,
                            d;
                        for (; ++f < r && f < o && !((d = c.get(e[f])) == null || d !== m + h);) h++;
                        if (h > m - a) {
                            const p = e[i];
    ...
    function vn(t, e, n, s = {}) {
        let r;
        return Kt(o => {
            r = o, e === document ? t() : F(e, t(), e.firstChild ? null : void 0, n)
        }, s.owner), () => {
            r(), e.textContent = ""
        }
    }
    ...
    function F(t, e, n, s) {
        if (n !== void 0 && !s && (s = []), typeof e != "function") return ye(t, e, s, n);
        ne(r => ye(t, e(), r, n), s)
    }
    ...
    function ye(t, e, n, s, r) {
        ...
        const o = typeof e,
            i = s !== void 0;
        if (t = i && n[0] && n[0].parentNode || t, o === "string" || o === "number") {
            if (o === "number" && (e = e.toString(), e === n)) return n;
            if (i) {
                let a = n[0];
                a && a.nodeType === 3 ? a.data !== e && (a.data = e) : a = document.createTextNode(e), n = H(t, n, s, a)
            ...
            if (Array.isArray(e)) {
                const a = [],
                    l = n && Array.isArray(n);
                if (Ue(a, e, n, r)) return ne(() => n = ye(t, a, n, s, !0)), () => n;
                if (a.length === 0) {
                    if (n = H(t, n, s), i) return n
                } else l ? n.length === 0 ? wt(t, a, s) : En(t, n, a) : (n && H(t), wt(t, a));
                n = a
            } else if (e.nodeType) {
                if (Array.isArray(n)) {
    ...
    function Ue(t, e, n, s) {
        ...
        for (let o = 0, i = e.length; o < i; o++) {
            ...
            if (!(a == null || a === !0 || a === !1))
                ...
                if (s) {
                    for (; typeof a == "function";) a = a();
                    r = Ue(t, Array.isArray(a) ? a : [a], Array.isArray(l) ? l : [l]) || r
                } else t.push(a), r = !0;
            else {
                const m = String(a);
                l && l.nodeType === 3 && l.data === m ? t.push(l) : t.push(document.createTextNode(m))
            }
        }
        return r
    }
        ...
        if (e.length) {
            ...
            for (let i = e.length - 1; i >= 0; i--) {
                ...
                if (r !== a) {
                    ...
                    !o && !i ? l ? t.replaceChild(r, a) : t.insertBefore(r, n) : l && a.remove()
                } else o = !0
            }
    ...
    function bt(t) {
        ...
        if (!e && (Object.defineProperty(t, K, {
            ...
            for (let r = 0, o = n.length; r < o; r++) {
                const i = n[r];
                s[i].get && Object.defineProperty(t, i, {
    ...
    function ie(t, e = new Set) {
        ...
        if (Array.isArray(t)) {
            ...
            for (let i = 0, a = t.length; i < a; i++) r = t[i], (s = ie(r, e)) !== r && (t[i] = s)
        } else {
            Object.isFrozen(t) ? t = Object.assign({}, t) : e.add(t);
            const i = Object.keys(t),
                a = Object.getOwnPropertyDescriptors(t);
            for (let l = 0, c = i.length; l < c; l++) o = i[l], !a[o].get && (r = t[o], (s = ie(r, e)) !== r && (t[o] = s))
        }
        return t
    }
    ...
    function xn(t, e) {
        ...
        return !n || n.get || !n.configurable || e === K || e === J || (delete n.value, delete n.writable, n.get = () => t[K][e]), n
    }
    ...
    const Cn = {
        get(t, e, n) {
            ...
            if (!r) {
                ...
                Te() && (typeof o != "function" || t.hasOwnProperty(e)) && !(i && i.get) && (o = ae(s, e, o)())
            }
            return we(o) ? bt(o) : o
        },
        has(t, e) {
            return e === ze || e === K || e === ot || e === J || e === U || e === "__proto__" ? !0 : (Te() && ae(Ae(t, U), e)(), e in t)
        },
        set() {
            return !0
        },
    ...
    function be(t, e, n, s = !1) {
        ...
        const r = t[e],
            o = t.length;
        n === void 0 ? (delete t[e], t[U] && t[U][e] && r !== void 0 && t[U][e].$()) : (t[e] = n, t[U] && t[U][e] && r === void 0 && t[U][e].$());
        let i = Ae(t, J),
            a;
        if ((a = ae(i, e, r)) && a.$(() => n), Array.isArray(t) && t.length !== o) {
    ...
    function Pn(t, e) {
        if (typeof e == "function" && (e = e(t)), e = ie(e), Array.isArray(e)) {
            if (t === e) return;
            let n = 0,
                s = e.length;
            for (; n < s; n++) {
    ...
    function le(t, e, n = []) {
        ...
        if (e.length > 1) {
            ...
            if (Array.isArray(s)) {
                ...
                for (let l = 0; l < t.length; l++) s(t[l], l) && le(t, [l].concat(e), n);
                return
            } else if (a && i === "object") {
                const {
                    from: l = 0,
        ...
        let o = e[0];
        typeof o == "function" && (o = o(r, n), o === r) || s === void 0 && o == null || (o = ie(o), s === void 0 || we(r) && we(o) && !Array.isArray(o) ? vt(r, o) : be(t, s, o))
    }
    ...
    const ve = Ne(Tn);
    var On = () => `uid::${ve(7)}`,
        Rn = (t, e = ["endpointName", "fingerprint"]) => typeof t == "object" && t !== null && e.every(n => n in t),
        kn = t => {
        ...
        Nn = () => {
            ...
            return {
                ...
                remove: e => {
                    t = typeof e == "string" ? t.filter(n => n.message.transactionId !== e) : t.filter(n => !e.includes(n))
                },
                entries: () => t
            }
        },
    ...
    function Dn() {
        return xt || (xt = 1, function(t, e) {
            (function(n, s) {
                s(t)
            })(typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : Ln, function(n) {
                ...
                if (typeof globalThis.browser > "u" || Object.getPrototypeOf(globalThis.browser) !== Object.prototype) {
                    const s = "The message port closed before a response was received.",
                        ...
                        o = i => {
                            ...
                            const c = y => y && typeof y == "object" && typeof y.then == "function",
                                m = (y, g) => (...u) => {
                                    i.runtime.lastError ? y.reject(new Error(i.runtime.lastError.message)) : g.singleCallbackArg || u.length <= 1 && g.singleCallbackArg !== !1 ? y.resolve(u[0]) : y.resolve(u)
                                },
                                f = y => y == 1 ? "argument" : "arguments",
                                h = (y, g) => function(E, ...M) {
                                    if (M.length < g.minArgs) throw new Error(`Expected at least ${g.minArgs} ${f(g.minArgs)} for ${y}(), got ${M.length}`);
                                    if (M.length > g.maxArgs) throw new Error(`Expected at most ${g.maxArgs} ${f(g.maxArgs)} for ${y}(), got ${M.length}`);
                                    return new Promise((k, L) => {
                                        if (g.fallbackToNoCallback) try {
                                            E[y](...M, m({
                                                resolve: k,
                                                reject: L
                                            }, g))
                                        } catch (A) {
                                            console.warn(`${y} API method doesn't seem to support the callback parameter, falling back to call it without a callback: `, A), E[y](...M), g.fallbackToNoCallback = !1, g.noCallback = !0, k()
                                        } else g.noCallback ? (E[y](...M), k()) : E[y](...M, m({
                                            resolve: k,
                                            reject: L
                                        }, g))
                                    })
                            ...
                            const w = (y, g = {}, u = {}) => {
                                        ...
                                        M = {
                                            ...
                                            get(L, A, D) {
                                                ...
                                                if (typeof P == "function")
                                                    if (typeof g[A] == "function") P = d(y, y[A], g[A]);
                                                    else if (p(u, A)) {
                                                    let ee = h(A, u[A]);
                                                    P = d(y, y[A], ee)
                                                } else P = P.bind(y);
                                                else if (typeof P == "object" && P !== null && (p(g, A) || p(u, A))) P = w(P, g[A], u[A]);
                                ...
                                x = new l(y => typeof y != "function" ? y : function(u) {
                                    const E = w(u, {}, {
                                        getContent: {
                                            minArgs: 0,
                                            maxArgs: 0
                            ...
                            let S = !1;
                            const I = new l(y => typeof y != "function" ? y : function(u, E, M) {
                                    let k = !1,
                                        L, A = new Promise(ue => {
                                            L = function(j) {
                                                S || (console.warn(r, new Error().stack), S = !0), k = !0, ue(j)
                                            }
                                        }),
                                        D;
                                    try {
                                    ...
                                    const ee = ue => {
                                        ue.then(j => {
                                            ...
                                            let rt;
                                            j && (j instanceof Error || typeof j.message == "string") ? rt = j.message : rt = "An unexpected error occurred", M({
                                ...
                                O = ({
                                    ...
                                    i.runtime.lastError ? i.runtime.lastError.message === s ? g() : y(new Error(i.runtime.lastError.message)) : u && u.__mozWebExtensionPolyfillReject__ ? y(new Error(u.message)) : g(u)
                                },
                                N = (y, g, u, ...E) => {
                                    if (E.length < g.minArgs) throw new Error(`Expected at least ${g.minArgs} ${f(g.minArgs)} for ${y}(), got ${E.length}`);
                                    if (E.length > g.maxArgs) throw new Error(`Expected at most ${g.maxArgs} ${f(g.maxArgs)} for ${y}(), got ${E.length}`);
    ...
    var jn = (t = "") => {
            ...
            const r = Nn(),
                ...
                a = (c, m) => {
                    switch (c.status) {
                        case "undeliverable":
                            s.some(f => f.message.messageID === c.message.messageID) || (s = [...s, {
                                message: c.message,
                                resolvedDestination: c.resolvedDestination
                            }]);
                            return;
                        case "deliverable":
                            s = s.reduce((f, h) => h.resolvedDestination === c.deliverableTo ? (We.toBackground(m, {
                                type: "deliver",
                                message: h.message
                            }), f) : [...f, h], []);
                            return;
                        case "delivered":
                            ...
                            return;
                        case "incoming":
                            c.message.messageType === "reply" && r.remove(c.message.messageID), o.forEach(f => f(c.message, m));
                            return;
                        case "terminated": {
                            const f = r.entries().filter(h => c.fingerprint === h.to);
                            r.remove(f), f.forEach(({
                                message: h
                            }) => i.forEach(d => d(h)))
                        }
                    }
                ...
                l = () => {
                    ...
                    }), n.onMessage.addListener(a), n.onDisconnect.addListener(l), We.toBackground(n, {
                        type: "sync",
                        pendingResponses: r.entries(),
                        pendingDeliveries: [...new Set(s.map(({
                            resolvedDestination: c
                        }) => c))]
                    })
                };
            return l(), {
        ...
        Ke, Bn = (t, e, n) => Ke ?? (Ke = new Promise(s => {
            const r = i => {
                    const {
                        data: {
                            cmd: a,
                    ...
                    if (a === "webext-port-offer" && l === e && c !== t) return window.removeEventListener("message", r), m[0].onmessage = n, m[0].postMessage("port-accepted"), s(m[0])
                },
                o = () => {
                    const i = new MessageChannel;
                    i.port1.onmessage = a => {
                        if (a.data === "port-accepted") return window.removeEventListener("message", r), s(i.port1);
                        n?.(a)
                    }, window.postMessage({
        ...
        Un = t => {
            ...
            return {
                ...
                onMessage: o => s = o,
                postMessage: async o => {
                    if (!n) throw new Error("Communication with window has not been allowed");
    ...
    function zn(t) {
        if (typeof t != "string" || t.trim().length === 0) throw new Error(`webext-bridge uses window.postMessage to talk with other "window"(s) for message routingwhich is global/conflicting operation in case there are other scripts using webext-bridge. Call Bridge#setNamespace(nsps) to isolate your app. Example: setNamespace('com.facebook.react-devtools'). Make sure to use same namespace across all your scripts whereever window.postMessage is likely to be used\``)
    }
    var Wn = Object.defineProperty,
        ...
        Pt = (t, e) => {
            ...
            if (St)
                for (var n of St(e)) Zn.call(e, n) && Ct(t, n, e[n]);
            return t
        },
        It = (t, e) => Kn(t, qn(e)),
        Vn = /^((?:background$)|devtools|popup|options|content-script|window)(?:@(\d+)(?:\.(\d+))?)?$/,
        Mt = t => {
    ...
    const Hn = [{
        ...
        Tt = ({
            ...
            for (const {
                ...
                of Hn) typeof t[a] == "string" && Object.defineProperty(i, a, {
                value: t[a],
                enumerable: !0,
                configurable: !0,
                writable: !0
    ...
    function Xn(t, e = {}) {
        ...
        return typeof t == "object" && t !== null ? Tt({
            from: t,
            seen: [],
            forceEnumerable: !0,
            maxDepth: n,
    ...
    var Yn = (t, e, n) => {
                ...
                i = a => {
                    if (a.destination.context === t && !a.destination.frameId && !a.destination.tabId) {
                        const {
                            ...
                            try {
                                const b = o.get(c);
                                if (typeof b == "function") d = await b({
                                    sender: a.origin,
                                    id: c,
                                    data: a.data,
                                    timestamp: a.timestamp
                                });
                                else throw w = !0, new Error(`[webext-bridge] No handler registered in '${t}' to accept messages with id '${c}'`)
                            } catch (b) {
                                p = b
                            } finally {
                                if (p && (a.err = Xn(p)), i(It(Pt({}, a), {
                                        messageType: "reply",
                                        data: d,
                                        origin: {
                                            context: t,
            ...
            return {
                ...
                endTransaction: a => {
                    const l = r.get(a);
                    l?.reject("Transaction was ended before it could complete"), r.delete(a)
                },
                sendMessage: (a, l, c = "background") => {
                    const m = typeof c == "string" ? Mt(c) : c,
                        f = "Bridge#sendMessage ->";
                    if (!m.context) throw new TypeError(`${f} Destination must be any one of known destinations`);
        ...
        X = class {
            constructor(t, e) {
                this.endpointRuntime = t, this.streamInfo = e, this.emitter = Ot(), this.isClosed = !1, this.handleStreamClose = () => {
                    this.isClosed || (this.isClosed = !0, this.emitter.emit("closed", !0), this.emitter.events = {})
                }, X.initDone || (t.onMessage("__crx_bridge_stream_transfer__", n => {
                    const {
                        streamId: s,
                        streamTransfer: r,
                        action: o
                    } = n.data, i = X.openStreams.get(s);
                    i && !i.isClosed && (o === "transfer" && i.emitter.emit("message", r), o === "close" && (X.openStreams.delete(s), i.handleStreamClose()))
                }), X.initDone = !0), X.openStreams.set(this.streamInfo.streamId, this)
            }
            get info() {
            ...
            close(t) {
                t && this.send(t), this.handleStreamClose(), this.endpointRuntime.sendMessage("__crx_bridge_stream_transfer__", {
                    streamId: this.streamInfo.streamId,
                    streamTransfer: null,
                    action: "close"
                }, this.streamInfo.endpoint)
    ...
    var Qn = t => {
            ...
            t.onMessage("__crx_bridge_stream_open__", i => new Promise(a => {
                ...
                const d = () => {
                    const p = n.get(m);
                    typeof p == "function" ? (p(new xe(t, It(Pt({}, c), {
                        endpoint: l
                    }))), f && h(), a(!0)) : f || (f = !0, h = s.on("did-change-stream-callbacks", d))
                };
                d()
            }));
            async function r(i, a) {
                if (e.has(i)) throw new Error("webext-bridge: A Stream is already open at this channel");
                const l = typeof a == "string" ? Mt(a) : a,
                    ...
                    m = new xe(t, c);
                return m.onClose(() => e.delete(i)), await t.sendMessage("__crx_bridge_stream_open__", c, l), e.set(i, m), m
            }
        ...
        ce = Yn("content-script", t => {
            t.destination.context === "window" ? Ge.postMessage(t) : Ze.postMessage(t)
        });
    Ge.onMessage(t => {
        t.origin = {
            context: "window",
    ...
    }), Ze.onMessage(ce.handleMessage), Ze.onFailure(t => {
    ...
    async function es(t, e = 100, n = 3e3) {
        try {
            ...
            let o = 0;
            for (let i = 0; i < r; i++) {
                o += Math.floor(Math.random() * s * 2), t.scrollTo({
                    top: o,
                    behavior: "smooth"
                });
    ...
    async function ts(t, e = 100, n = 5e3) {
        try {
            const s = t.document.querySelector("div.overflow-y-scroll.overflow-x-visible"),
                r = s || t,
    ...
    var ns = q("<h4>Email: "),
        ss = q("<p><strong>"),
        rs = q('<div class=current-task><p>­ƒôØ Next URL:</p><a rel="noopener noreferrer">'),
        os = q("<div class=hw-top><h4>Username: </h4><p>Status:  <span></span></p><details><summary>­ƒôè Data Statistics</summary><div>"),
    ...
    const cs = t => (() => {
        ...
        return e.style.setProperty("min-height", "250px"), e.style.setProperty("min-width", "250px"), e.style.setProperty("max-width", "300px"), e.style.setProperty("background-color", "#EE4D2D"), e.style.setProperty("color", "white"), e.style.setProperty("padding", "12px"), e.style.setProperty("font-family", "system-ui, -apple-system, sans-serif"), e.style.setProperty("word-wrap", "break-word"), e.style.setProperty("overflow-wrap", "break-word"), e.style.setProperty("opacity", "0.8"), e.style.setProperty("transition", "opacity 0.2s ease"), F(n, () => t.state.username, null), F(e, Re(ke, {
        ...
        }), s), o.style.setProperty("font-weight", "bold"), F(o, () => t.state.isFetching ? "ÔùÅ running" : "Ôùï idle"), F(e, Re(ke, {
            get when() {
            ...
            get children() {
                var c = rs(),
                    m = c.firstChild,
                    f = m.nextSibling;
                return c.style.setProperty("word-break", "break-all"), c.style.setProperty("background-color", "rgba(0,0,0,0.2)"), c.style.setProperty("padding", "8px"), c.style.setProperty("border-radius", "4px"), m.style.setProperty("font-weight", "bold"), f.style.setProperty("font-size", "0.9em"), F(f, () => t.state.currentTask), ne(() => _n(f, "href", t.state.currentTask)), c
            }
        }), i), a.style.setProperty("cursor", "pointer"), a.style.setProperty("padding", "4px 0"), a.style.setProperty("font-weight", "bold"), l.style.setProperty("background-color", "rgba(0,0,0,0.2)"), l.style.setProperty("padding", "8px"), l.style.setProperty("border-radius", "4px"), l.style.setProperty("margin-top", "4px"), l.style.setProperty("font-family", "monospace"), F(l, () => JSON.stringify(t.state.crawlStats)?.replace(/[,\{\}]/g, `
`).replace(/["]/g, "").replace(/:1/g, ": Ô£à").split(`
`).filter(c => c.trim()).map(c => (() => {
            var m = ls();
            return F(m, c), m
        })())), ne(c => (c = t.state.isFetching ? "#4CAF50" : "#FFA726") != null ? o.style.setProperty("color", c) : o.style.removeProperty("color")), e
    })();
    ...
    function us(t) {
        return new Promise(e => {
            ...
            const n = new MutationObserver(s => {
                document.querySelector(t) && (n.disconnect(), e(document.querySelector(t)))
            });
    ...
    function ds() {
        return kt || (kt = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])
    }

    function ms() {
        return Nt || (Nt = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])
    }
    ...
    function hs(t) {
        return ms().includes(t) ? function(...e) {
    ...
    function ps(t) {
        return typeof t == "function" ? hs(t) : (t instanceof IDBTransaction && fs(t), Ve(t, ds()) ? new Proxy(t, Xe) : t)
    }
    ...
    function ys(t, e, {
        ...
        }), n && i.addEventListener("blocked", l => n(l.oldVersion, l.newVersion, l)), a.then(l => {
            o && l.addEventListener("close", () => o()), r && l.addEventListener("versionchange", c => r(c.oldVersion, c.newVersion, c))
        }).catch(() => {}), a
    }
    ...
    function Dt(t, e) {
        ...
        const n = e.replace(/FromIndex$/, ""),
            s = e !== n,
            r = As.includes(n);
        if (!(n in (s ? IDBIndex : IDBObjectStore).prototype) || !(r || ws.includes(n))) return;
    ...
    async function* vs(...t) {
        ...
        for ($t.set(n, e), Se.set(n, Ye(e)); e;) yield n, e = await (et.get(n) || e.continue()), et.delete(n)
    }
    ...
    class Q {
        ...
        constructor() {
            this.db = ys("settings-db", 2, {
                upgrade(e) {
                    e.objectStoreNames.contains("settings") || e.createObjectStore("settings", {
                        keyPath: "key"
                    })
                }
        ...
        async setSetting(e, n) {
            try {
                await (await this.db).put("settings", {
                    key: e,
                    value: n
        ...
        subscribe(e, n) {
            return this.listeners.has(e) || this.listeners.set(e, new Set), this.listeners.get(e)?.add(n), () => {
    ...
    class v {
        ...
        static CAPTCHA_PRESENCE_INDICATORS = ['aside[aria-modal=true] div[style="width: 40px; height: 40px; transform: translateX(0px);"]', "#NEW_CAPTCHA", "#captchaMask", "body.captcha-disable-scroll"];
        isCurrentlySolving = !1;
        constructor() {
            window.hasRun !== !0 && (window.hasRun = !0, this.setupMessageListener(), this.solveCaptchaLoop())
        }
        setupMessageListener() {
            te.runtime.onMessage.addListener((e, n, s) => {
                e.apiKey ? (localStorage.setItem("sadCaptchaKey", e.apiKey), s({
                    message: "API key set.",
                    success: 1
                })) : s({
        ...
        async imageCrawlApiCall(e) {
            ...
            return console.log("Pixels from slider origin = " + s.pixelsFromSliderOrigin), s.pixelsFromSliderOrigin
        }
        async puzzleApiCall(e, n) {
            ...
            return console.log("slideXProportion = " + r.slideXProportion), r.slideXProportion
        }
                            ...
                            for (const i of Array.from(o.addedNodes))
                                for (const a of e)
                                    if (i instanceof Element && i.querySelector(a)) {
                                        console.debug(`Element matched ${a}`), s.disconnect(), n(i.querySelector(a));
                                        return
                                    }
                        }
                });
        ...
        waitForElement(e) {
            return new Promise(n => {
                ...
                const r = new MutationObserver(o => {
                    ...
                    i && (r.disconnect(), console.log("Selector found by mutation observer: " + e), n(i))
                });
        ...
        anySelectorInListPresent(e) {
            return e.some(n => document.querySelector(n) ? (console.log(`Selector ${n} is present`), !0) : !1)
        }
        async identifyCaptcha() {
            for (let e = 0; e < 30; e++) {
                if (this.anySelectorInListPresent(v.IMAGE_CRAWL_UNIQUE_IDENTIFIERS)) return console.log("Image crawl detected"), 1;
                if (this.anySelectorInListPresent(v.PUZZLE_UNIQUE_IDENTIFIERS)) return console.log("Puzzle detected"), 0;
        ...
        dispatchMouseEvent(e, n, s, r) {
            (r || document.elementFromPoint(n, s) || v.CONTAINER).dispatchEvent(new MouseEvent(e, {
                bubbles: !0,
                cancelable: !0,
                view: window,
                clientX: n,
        ...
        dispatchPointerEvent(e, n, s, r) {
            (r || v.CONTAINER).dispatchEvent(new PointerEvent(e, {
                pointerType: "mouse",
                bubbles: !0,
                cancelable: !0,
                view: window,
        ...
        clickElement(e) {
            ...
            const s = n.getBoundingClientRect(),
                r = s.x + s.width / 2,
                o = s.y + s.height / 2;
            this.mouseMove(r, o), this.mouseOver(r, o), this.dispatchPointerEvent("click", r, o, n)
        }
        getElementCenter(e) {
        ...
        async refreshImageCrawl() {
            ...
            for (this.clickElement(v.IMAGE_CRAWL_RESET_BUTTON); await this.getImageSource(v.IMAGE_CRAWL_PUZZLE_IMAGE_SELECTOR) === e;) console.log("Waiting for refresh..."), await new Promise(n => setTimeout(n, 100));
            console.log("Refresh complete")
        }
        async refreshPuzzle() {
            const e = await this.getImageSource("#captcha-verify-image");
            for (this.clickElement('a[class*="refresh-button___StyledA-wyjjd0-0 VWPcJ secsdk_captcha_refresh"]'); await this.getImageSource(v.IMAGE_CRAWL_PUZZLE_IMAGE_SELECTOR) === e;) console.log("Waiting for refresh..."), await new Promise(n => setTimeout(n, 100));
            console.log("Refresh complete")
        }
        generateNaturalApproach(e, n, s) {
            const r = {
                    x: e.x + (n.x - e.x) * (.2 + Math.random() * .2),
                    y: e.y + (Math.random() * 15 - 5)
                },
                o = {
                    x: e.x + (n.x - e.x) * (.6 + Math.random() * .2),
                    y: n.y + (Math.random() * 10 - 5)
                },
                i = [];
            for (let a = 0; a <= s; a++) {
                const l = a / s,
                    c = Math.pow(1 - l, 3) * e.x + 3 * Math.pow(1 - l, 2) * l * r.x + 3 * (1 - l) * Math.pow(l, 2) * o.x + Math.pow(l, 3) * n.x,
                    m = Math.pow(1 - l, 3) * e.y + 3 * Math.pow(1 - l, 2) * l * r.y + 3 * (1 - l) * Math.pow(l, 2) * o.y + Math.pow(l, 3) * n.y;
                i.push({
                    x: c,
                    y: m
                })
        ...
        async mouseApproach(e, n) {
            ...
            for (const i of o) this.mouseMove(i.x, i.y), await new Promise(a => setTimeout(a, 15 + Math.random() * 25));
            await new Promise(i => setTimeout(i, 200 + Math.random() * 150)), this.mouseMove(e + (Math.random() * 1.5 - .75), n + (Math.random() * 1.5 - .75))
        }
        ...
        async getSlidePieceTrajectory(e, n) {
            ...
            const r = this.getElementWidth(n),
                ...
                a = [],
                l = 3;
            this.mouseDown(o.x, o.y), await new Promise(c => setTimeout(c, 180 + Math.random() * 120));
            for (let c = 0; c < r * .85; c += l) {
                const m = o.x + c,
                    f = o.y - Math.log(c + 1);
                this.mouseMove(m, f, e), await new Promise(d => setTimeout(d, 10));
        ...
        async solveImageCrawl() {
            await this.refreshImageCrawl(), await new Promise(h => setTimeout(h, 500));
            const [e, n] = await Promise.all([this.getImageSource(v.IMAGE_CRAWL_PUZZLE_IMAGE_SELECTOR), this.getImageSource(v.IMAGE_CRAWL_PIECE_IMAGE_SELECTOR)]), s = this.getBase64StringFromDataURL(e), r = this.getBase64StringFromDataURL(n), o = document.querySelector(v.IMAGE_CRAWL_BUTTON_SELECTOR), i = document.querySelector(v.IMAGE_CRAWL_PUZZLE_IMAGE_SELECTOR);
            if (!o || !i) throw new Error("Image crawl elements not found");
            const a = this.getElementCenter(o);
            await this.mouseApproach(a.x, a.y), await new Promise(h => setTimeout(h, 350 + Math.random() * 200));
            const l = await this.getSlidePieceTrajectory(o, i),
                ...
                m = a.x + c,
                f = this.generateNaturalApproach(a, {
                    x: m,
                    y: a.y
                }, 20 + Math.floor(Math.random() * 10));
            for (const h of f) this.mouseMove(h.x, h.y), await new Promise(d => setTimeout(d, 20 + Math.random() * 30));
            await new Promise(h => setTimeout(h, 100 + Math.random() * 150)), this.mouseUp(m, a.y)
        }
        async solvePuzzle() {
            ...
            await this.mouseApproach(n.x, n.y), await new Promise(h => setTimeout(h, 133.7)), this.mouseDown(n.x, n.y), await new Promise(h => setTimeout(h, 133.7));
            const [s, r] = await Promise.all([this.getImageSource("#captcha-verify-image"), this.getImageSource('img[class*="captcha_verify_img_slide"]')]), o = await this.getImageBase64(s), i = await this.getImageBase64(r), a = await this.puzzleApiCall(o, i), l = await this.waitForElement('img[class*="sc-ifAKCX itlNmx sc-gqjmRU cHbGdz"]');
            if (console.log("Puzzle image element found:", l), !l) throw new Error("Puzzle image element not found");
            const c = this.computePuzzleSlideDistance(a, l),
                m = n.x + c,
                f = this.generateNaturalApproach(n, {
                    x: m,
                    y: n.y
                }, 5 + Math.floor(Math.random() * 15));
            for (const h of f) {
                const d = Math.random() * 4 - 2;
                this.mouseMove(h.x, h.y + d), await new Promise(p => setTimeout(p, 10 + Math.random() * 20))
            }
            await new Promise(h => setTimeout(h, 133.7)), this.mouseUp(m, n.y)
        }
        captchaIsPresent() {
            return v.CAPTCHA_PRESENCE_INDICATORS.some(e => document.querySelector(e) ? (console.log("Captcha present based on selector: " + e), !0) : !1)
        }
        async solveCaptchaLoop() {
            for (;;) {
                if (!this.isCurrentlySolving) {
                    this.captchaIsPresent() || (console.log("Waiting for captcha..."), await this.findFirstElementToAppear(v.CAPTCHA_PRESENCE_INDICATORS), console.log("Captcha detected by mutation observer.")), this.isCurrentlySolving = !0;
                    try {
                        ...
                        this.isCurrentlySolving = !1, await new Promise(e => setTimeout(e, 5e3))
                    }
                }
        ...
        async solveCaptchaOnce() {
            try {
                if (await this.creditsApiCall() <= 0) return console.log("Out of credits"), {
                    isSolved: !1,
                ...
                return console.log("Captcha solve attempt finished."), {
                    isSolved: !0,
                    message: "Captcha solve attempt finished."
                }
            } catch (e) {
                return console.error("Error during single captcha solve:", e), {
                    isSolved: !1,
